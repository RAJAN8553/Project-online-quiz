  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==6) echo'class="active"'; ?>><a href="dash.php?q=6">Instructor</a></li>
...
$result = mysqli_query($con,"SELECT * FROM instructor") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
...
while($row = mysqli_fetch_array($result)) {
  ...
  <td><a title="Delete instructor" href="update.php?diemail='.$email.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td></tr>';
}
$c=0;
echo '</table></div></div>';
